...
from wenet.transformer.search import (ctc_greedy_search, ctc_prefix_beam_search, attention_beam_search, attention_rescoring, DecodeResult)
from wenet.utils.mask import make_pad_mask
from wenet.utils.common import (IGNORE_ID, add_sos_eos, th_accuracy, reverse_pad_list)
...
class TextBert(torch.nn.Module):
    ...
    def forward(
        ...
        pny = batch['pny'].to(device)
        pny_lengths = batch['pny_lengths'].to(device)
        ...
        encoder_out, encoder_mask = self.encoder(pny, pny_lengths)
