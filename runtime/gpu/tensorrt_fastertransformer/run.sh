...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
     ...
     mkdir -p /weight/enc
     mkdir -p /weight/dec
     python3 extract_weights.py --input_onnx $onnx_model_dir/audio_encoder.onnx --output_dir /weight/enc || exit 1
     python3 extract_weights.py --input_onnx $onnx_model_dir/context_decoder.onnx --output_dir /weight/dec || exit 1
